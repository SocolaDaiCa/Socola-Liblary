...
<body rightmargin="400" leftmargin="400">
<body datasqstyle="{&quot;paddingTop&quot;:null}" datasquuid="09c53f89-24c3-4d51-8a3c-ae418f63615a" style="padding-top: 40px;"/>
<div class="container">
    <div class="panel panel-primary">
    <div class="panel-heading">Youtube Video Downloader</div>
    <br/>
    <form action="" method="post" id="download-form">
        <div class="row">
            <div class="col-md-10" style="left: 1%;">
    ...
    <h3 id="video-name" style="text-align: center;text-transform: uppercase;">
        <?php if ($isSuccessResponse): ?>
            ...
            <div id="video-preview">
                <?php if ($isSuccessResponse): ?>
                    <img src="<?= $baseInfo['previewUrl'] ?>" alt="Video preview"
                         class="img-responsive img-thumbnail img-rounded" style="max-width:100% ;margin: 0 auto; display: block;">
                <?php endif; ?>
            </div>
